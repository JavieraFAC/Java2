...
public class Listar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldFiltrarGenero.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jTextFieldAnno1.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jTextFieldAnno2.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void jTextFieldAnno1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAnno1KeyTyped
        ...
        if (jTextFieldAnno1.getText().length() == 4) {
            evt.consume();
        }
    ...
    private void jTextFieldAnno2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAnno2KeyTyped
        ...
        if (jTextFieldAnno2.getText().length() == 4) {
            evt.consume();
        }
    ...
    public void filtroEntreAnos() {
        
        try{
            
            // Traer texto annos
            String tAnno1 = jTextFieldAnno1.getText();
            String tAnno2 = jTextFieldAnno2.getText();
            
            // verificar campos vacios
            if(tAnno1.isEmpty() || tAnno2.isEmpty()){
                return;
            }
            // convertir a numero 
            int Anno1 = Integer.parseInt(tAnno1);
            int Anno2 = Integer.parseInt(tAnno2);

            int columnaFiltro = 3;
            int columnaFiltroGenero = 5;
            
            List<RowFilter<Object, Object>> filters = new ArrayList<>();

            filters.add(RowFilter.numberFilter(RowFilter.ComparisonType.AFTER, Anno1, columnaFiltro));
            filters.add(RowFilter.numberFilter(RowFilter.ComparisonType.BEFORE, Anno2, columnaFiltro));
            filters.add(RowFilter.regexFilter(jTextFieldFiltrarGenero.getText(), columnaFiltroGenero));
            this.trsfiltro.setRowFilter(RowFilter.andFilter(filters));
        
        
        
        
        } catch(NumberFormatException e){
            System.out.println("Error al convertir a numero" + e.getMessage());
        }
